...
def ucz(per, tr_data):
    ...
    print " tutaj powinno byc 0 " + str(per.guess([0, 0, 1]))
    print " tutaj powinno byc 0 " + str(per.guess([0, 1, 1]))
    print " tutaj powinno byc 0 " + str(per.guess([1, 0, 1]))
    print " tutaj powinno byc 1 " + str(per.guess([1, 1, 1]))
